...
FROM 
    Inventory_Jambo a
INNER JOIN 
    [Jambo Supplies Ltd_$Item$437dbf0e-84ff-417a-965d-ed2bb9650972] b 
...
save_path = r'\\172.30.36.151\Amazon Data\Jambo Supplies Limited\Inventory\inventory_output.xlsx'
